          ...
          <div className="flex flex-col md:flex-row gap-4 items-center justify-between">
            <div>
              ...
              <select
                ...
                className="px-4 py-3 border-2 border-gray-200 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-400 bg-gray-50/50 font-medium transition-all"
              >
                      ...
                      {order.items?.map((item) => (
                        <div key={item.id} className="flex justify-between items-center bg-gray-50 p-3 rounded-lg">
                          ...
                          <div className="text-right">
                            ...
                            <p className="text-sm font-bold text-blue-600">{settings.currency}{item.total_cost.toFixed(2)}</p>
                          </div>
                        </div>
                      ))}
                    </div>
